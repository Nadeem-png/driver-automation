...
function updateCalculator() {
    ...
    hourlyProfitPc.innerHTML = (zero * hourlyProfitRate * 100).toFixed(pcPrecision) + '%';
    ...
    dailyProfitPc.innerHTML = (zero * dailyProfitRate * 100).toFixed(pcPrecision) + '%';
    ...
    weeklyProfitPc.innerHTML = (zero * weeklyProfitRate * 100).toFixed(pcPrecision) + '%';
    ...
    monthlyProfitPc.innerHTML = (zero * monthlyProfitRate * 100).toFixed(pcPrecision) + '%';
